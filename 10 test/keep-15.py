...
# Define paths
xml_file_path = 'D:/Hamtaa project/10 test/keep-15.xml'  # Ensure this path is correct
...
g.serialize(destination='D:/Hamtaa project/keep-15.ttl', format='turtle')

print("RDF data has been saved to 'D:/Hamtaa project/keep-15.ttl'.")