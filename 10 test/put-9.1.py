...
# Define paths
xml_file_path = 'D:/Hamtaa project/put-9.1.xml'  # Ensure this path is correct
...
g.serialize(destination='put-9.1.ttl', format='turtle')

print("RDF data has been saved to 'put-9.1.ttl'.")