...
# Define paths
xml_file_path = 'D:/Hamtaa project/10 test/separate-23.1.xml'  # Ensure this path is correct
...
g.serialize(destination='D:/Hamtaa project/10 test/separate-23.1.ttl', format='turtle')

print("RDF data has been saved to 'D:/Hamtaa project/10 test/separate-23.1.ttl'.")