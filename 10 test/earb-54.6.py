...
# Define paths
xml_file_path = 'D:/Hamtaa project/10 test/earn-54.6.xml'  # Ensure this path is correct
...
g.serialize(destination='D:/Hamtaa project/10 test/earn-54.6.ttl', format='turtle')

print("RDF data has been saved to 'D:/Hamtaa project/10 test/earn-54.6.ttl'.")