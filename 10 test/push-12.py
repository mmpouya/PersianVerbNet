...
# Define paths
xml_file_path = 'D:/Hamtaa project/push-12.xml'  # Ensure this path is correct
...
g.serialize(destination='D:/Hamtaa project/push-12.ttl', format='turtle')

print("RDF data has been saved to 'push-12.ttl'.")