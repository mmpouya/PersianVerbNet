...
# Define paths
xml_file_path = 'D:/Hamtaa project/send-11.1.xml'  # Ensure this path is correct
...
g.serialize(destination='D:/Hamtaa project/send-11.1.ttl', format='turtle')

print("RDF data has been saved to 'send-11.1.ttl'.")